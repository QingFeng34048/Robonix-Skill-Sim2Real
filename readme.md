...
We also evaluate the developed robotic skills under different training and deployment settings. Detailed results are available in the [Benchmark and Metrics](#benchmark) section.
